...
2. Use Gate 1 mechanics from [`TO-PRD.md`](TO-PRD.md) to preview the exact PRD/domain delta. Append one dated line to the PRD's `## Amendments` section (create it once) describing what changed and why. Bind confirmation to the changed draft, targets, and base hashes; any drift renews consent.
