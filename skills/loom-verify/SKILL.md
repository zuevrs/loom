...
2. Pin one immutable Boundary: self-excluding Ticket digest; ordered repository identities, HEAD/fixed points, actual non-empty diff and digests; maker identity/result; and included semantics. `TICKET-RECORD.md` owns exact self-exclusion and staleness.
