...
- No violation of the [`EXECUTION.md`](EXECUTION.md) maker/wave contract: no worker chaining across Tickets, no maker self-approval, no fabricated custom-agent availability.
