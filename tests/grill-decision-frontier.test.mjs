...
const obligations=[
  ...
  ["exactly one visible question","frontier",[/frontier/],[/exactly one visible.*user owned.*decision question/],[/at a time/]],
  ...
  ["worker cannot replace question","frontier",[/lookup result/],[/evidence only/],[/replace the visible question/]],
...
const mutations=[
  ...
  ["visible question bound",text=>text.replace("exactly one visible, user-owned, load-bearing decision question at a time","visible decision questions")],
  ...
  ["authority prohibition: replace",text=>text.replace("replace the visible question, ","")],
