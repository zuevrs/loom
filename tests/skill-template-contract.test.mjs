...
const cases=[
  ...
  ["dispatcher missing ambiguous intent STOP","loom/SKILL.md",text=>text.replace(" or intent stays ambiguous after its one question — closed ambiguity never routes to Grill or Plan",""),/closed stop-signal set/],
